...
class ConnectionServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.FindContacts = channel.unary_unary(
                '/connection.ConnectionService/FindContacts',
...
class ConnectionService(object):
    ...
    def FindContacts(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/connection.ConnectionService/FindContacts',
            connection__pb2.ConnectionRequest.SerializeToString,
