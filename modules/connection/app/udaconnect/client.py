...
def get_connections():
    ...
    channel = grpc.insecure_channel('localhost:30050')
    ...
    request = connection_pb2.ConnectionRequest(person_id=1, start_date="2023-02-10", end_date="2023-02-15", meters=5000)
